...
const functionCreated = function func1() {
    console.log('I am a function attached with a constant');
};
...
function functionObject() {
    console.log('Call me, I am in the object');
};
object = {
    'key': functionObject
}
object.key() //You should call it via the key in the object.
